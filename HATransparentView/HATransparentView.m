...
#define kDefaultBackground [UIColor colorWithWhite:0.0 alpha:1];//0.9
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone){    
            close.frame = CGRectMake(self.frame.size.width - 60, 73, 60, 30);
        } else {
            close.frame = CGRectMake(self.frame.size.width - 60 - 448, 13, 60, 30);
        }
