...
- (void)sharingView:(AGPhotoBrowserOverlayView *)sharingView didTapOnSeeMoreButton:(UIButton *)actionButton
{
    ...
    NSDictionary *stringAttributes = [NSDictionary dictionaryWithObject:sharingView.descriptionLabel.font forKey: NSFontAttributeName];
    
    CGSize descriptionSize = [sharingView.description boundingRectWithSize:maximumLabelSize
