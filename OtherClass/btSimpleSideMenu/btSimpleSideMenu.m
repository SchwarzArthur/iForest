...
#define BACKGROUND_COLOR [UIColor blackColor]//colorWithWhite:0 alpha:0.9
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(cell == nil){
        ...
        circleView.layer.borderColor = [UIColor whiteColor].CGColor;//[UIColor colorWithWhite:0.3 alpha:0.7].CGColor;
        ...
        titleLabel.textColor = [UIColor whiteColor];//[UIColor colorWithWhite:0.2 alpha:1];
        titleLabel.font = [UIFont fontWithName:@"Avenir Next" size:16];
        
        [cell.contentView addSubview:titleLabel];
        
        imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 55, 55)];//(0, 0, 32, 32)];
...
-(void)commonInit:(UIViewController *)sender{
    ...
    self.frame = CGRectMake(-width, yAxis, width, height);
    self.backgroundColor = [UIColor colorWithRed:0/255 green:0/255 blue:0/255 alpha:1];//BACKGROUND_COLOR;//0.9
   ...
   // blurredImage = [screenShotImage blurredImageWithRadius:10.0f iterations:5  tintColor:nil];//close by me
