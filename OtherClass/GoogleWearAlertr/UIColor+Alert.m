...
+(UIColor*)successGreen{
    ...
    return  [UIColor colorWithRed:0/255.0 green:161/225.0 blue:0/255.0 alpha:1.0];//[UIColor colorWithRed:69.0/255.0 green:181.0/255.0 blue:38.0/255.0 alpha:1];

}
+(UIColor*)errorRed  {
    return  [UIColor redColor];//[UIColor colorWithRed:255.0/255.0 green:82.0/255.0 blue:82.0/255.0 alpha:1];
}
