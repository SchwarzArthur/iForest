...
+(MKPolygon *)polygon:(MKPolygon *)poly1 intersectedWithSecondPolygon:(MKPolygon *)poly2{
    ...
    NSInteger poly1Count = poly1.pointCount;
    ...
    NSInteger poly2Count = poly2.pointCount;
    ...
    NSInteger MKPolygon1Count = polygon1.pointCount;
    NSInteger MKPolygon2Count = polygon2.pointCount;
    ...
    NSInteger count = finalPolygon.count;
