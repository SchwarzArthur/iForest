...
- (void)viewWillAppear:(BOOL)animated {
    ...
    customLayer_.lineWidth = self.view.frame.size.width * 0.03;
    ...
    customLayer2_.lineWidth = self.view.frame.size.width * 0.02;
    ...
    customLayer3_.lineWidth = self.view.frame.size.width * 0.01;
