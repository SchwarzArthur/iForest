...
+ (void)initialize
{
    ...
    [appearance setBlurTintColor:[UIColor colorWithWhite:0.0f alpha:1.0f]];//[UIColor colorWithWhite:1.0f alpha:0.5f]];
    ...
    [appearance setSelectedBackgroundColor:[[UIColor lightGrayColor]colorWithAlphaComponent:0.8f]];//[UIColor colorWithWhite:0.8f alpha:0.5f]];
    [appearance setCancelButtonTextAttributes:@{ NSFontAttributeName : [UIFont fontWithName:@"Avenir Next" size:17],
                                                 NSForegroundColorAttributeName : [UIColor darkGrayColor] }];
    [appearance setButtonTextAttributes:@{ NSFontAttributeName : [UIFont fontWithName:@"Avenir Next" size:15], NSForegroundColorAttributeName : [UIColor whiteColor]}];
    [appearance setDestructiveButtonTextAttributes:@{ NSFontAttributeName : [UIFont fontWithName:@"Avenir Next" size:15],
                                                      NSForegroundColorAttributeName : [UIColor redColor] }];
    [appearance setTitleTextAttributes:@{ NSFontAttributeName : [UIFont fontWithName:@"Avenir Next" size:14],
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.tintColor = attributes[NSForegroundColorAttributeName] ? attributes[NSForegroundColorAttributeName] : [UIColor whiteColor];
...
- (void)setUpTableView
{
    ...
    tableView.separatorColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.1f];
...
- (void)setUpTableViewHeader
{
    ...
    if (self.tableView.tableHeaderView && self.tableView.separatorStyle != UITableViewCellSeparatorStyleNone) {
        ...
        separator.backgroundColor = self.tableView.separatorColor;//[UIColor darkGrayColor];
