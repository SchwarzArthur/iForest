...
- (void)setBadgeValue:(NSString *)badgeValue
{
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"0"] && self.shouldHideBadgeAtZero)) {
        ...
        self.badge.layer.shadowColor = [UIColor blackColor].CGColor;
        self.badge.layer.shadowOpacity = 0.2;
        self.badge.layer.shadowOffset = CGSizeMake(0, 1);
        self.badge.layer.shadowRadius = 2.0f;
